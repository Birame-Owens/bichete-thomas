...
export function Panel({
  ...
  return (
    <section className={`rounded-xl border border-[#f1e7ee] bg-white p-4 shadow-[0_16px_34px_-30px_rgba(20,20,43,0.5)] sm:p-5 ${className}`}>
...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/45 px-2 py-2 sm:items-center sm:px-4 sm:py-6">
      <section className="max-h-[95vh] w-full max-w-5xl overflow-y-auto rounded-xl bg-white p-4 shadow-2xl sm:max-h-[92vh] sm:p-5">
